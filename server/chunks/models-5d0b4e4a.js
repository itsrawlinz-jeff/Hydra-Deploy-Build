import { H as HF_ACCESS_TOKEN, O as OPENAI_API_KEY, a as MODELS, b as OLD_MODELS, c as HF_API_ROOT } from './private-5bef27a4.js';
...
async function endpointAws({
  ...
  let AwsClient;
  try {
    AwsClient = (await import('./aws4fetch.esm-c5cac1fc.js')).AwsClient;
  } catch (e) {
...
async function endpointOai({
  ...
  let OpenAI;
  try {
    OpenAI = (await import('./index-0d18c6d9.js').then(function (n) { return n.a; })).OpenAI;
  } catch (e) {
...
export { buildPrompt as b, defaultModel as d, models as m, oldModels as o, smallModel as s, validateModel as v };
//# sourceMappingURL=models-5d0b4e4a.js.map
